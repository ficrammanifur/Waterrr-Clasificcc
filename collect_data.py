...
# ===== DAFTAR JENIS AIR =====
JENIS_AIR = [
    "1=Mineral", "2=RO/Demineral", "3=Alkaline",
    "4=Air Rebus", "5=Air Dispenser", "6=Air Isi Ulang"
]

print("=== DATASET COLLECTOR - 26 SAMPLE AIR ===")
...
# Header CSV
try:
    with open("dataset_air.csv", "x") as f:
...
while True:
    ...
    with open("dataset_air.csv", "a") as f:
        for i in range(200):
    ...
    print("  Bilas SEMUA probe (pH, TDS, turbidity) sebelum lanjut")

print("\n=== SELESAI ===")
print("Dataset tersimpan di dataset_air.csv")
print("Download via Thonny: Files panel -> klik kanan dataset_air.csv -> Download")
